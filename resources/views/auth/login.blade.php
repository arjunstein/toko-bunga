                    ...
                    <form class="form w-100" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="text-center mb-10">
                            ...
                            <div class="text-gray-400 fw-bold fs-4">Belum punya akun?
                                <a href="{{ route('register') }}" class="link-primary fw-bolder">Buat akun disini</a>
                            </div>
                            <!--end::Link-->
                        </div>
                        <!--begin::Heading-->
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <!--begin::Input-->
                            <input
                                class="form-control form-control-lg form-control-solid @error('whatsapp') is-invalid @enderror"
                                type="number" id="whatsapp" name="whatsapp" required value="{{ old('whatsapp') }}"
