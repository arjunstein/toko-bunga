...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link rel="shortcut icon" href="assets/media/logos/icon.webp" />
		<!--begin::Fonts-->
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sketchy-1/14.png">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<a href="#" class="mb-12">
						<img alt="Logo" src="assets/media/logos/logo.webp" class="h-45px" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" action="{{ route('login') }}" method="POST">
							...
							<div class="text-center mb-10">
								...
								<a href="{{ route('register') }}" class="link-primary fw-bolder">Buat akun disini</a></div>
								<!--end::Link-->
							</div>
							<!--begin::Heading-->
							<!--begin::Input group-->
							<div class="fv-row mb-10">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid @error('whatsapp') is-invalid @enderror" type="number" id="whatsapp" name="whatsapp" required value="{{ old('whatsapp') }}" required autocomplete="whatsapp" />
								<!--end::Input-->
								@error('whatsapp')
				...
				<div class="d-flex flex-center flex-column-auto p-10">
					...
					<div class="d-flex align-items-center fw-bold fs-6">
						...
						<a href="#" class="text-muted text-hover-primary px-2">Toko</a>
