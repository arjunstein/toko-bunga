                                        ...
                                        <div class="col">
                                            <div class="mb-10 fv-row mt-2">
                                                ...
                                                <input type="text" name="namaProduk"
                                                    ...
                                                    value="{{ $product->namaProduk }}" placeholder="Nama Produk" />
                                                <!--end::Input-->
                                                @error('namaProduk')
                                            ...
                                            <div class="mb-10 fv-row mt-2">
                                                ...
                                                <input type="text" name="slug"
                                                    ...
                                                    value="{{ $product->slug }}" placeholder="Slug" disabled />
                                                <!--end::Input-->
                                                @error('slug')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="mb-10 fv-row mt-2">
                                                ...
                                                <input type="number" name="harga"
                                                    ...
                                                    value="{{ $product->harga }}" placeholder="Harga Produk" />
                                                <!--end::Input-->
                                                @error('harga')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="mb-10 fv-row mt-2">
                                                ...
                                                <input type="text" name="gambar"
                                                    ...
                                                    value="{{ $product->gambar }}" placeholder="gambar" />
                                                <!--end::Input-->
                                                @error('gambar')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="mb-10 fv-row mt-2">
                                                ...
                                                <textarea name="deskripsi" id="deskripsi"
                                                    class="form-control form-control-solid mb-3 mb-lg-0 @error('deskripsi') is-invalid @enderror" rows="4">{{ $product->deskripsi }}</textarea>
                                                @error('deskripsi')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
