                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/users/' . $usr->id . '/edit') }}"
                                            class="text-gray-800 text-hover-primary mb-1">{{ $usr->name }}</a>
                                    </td>
                                    <td>{{ $usr->privilege }}</td>
                                    <td>{{ $usr->email }}</td>
                                    <td>{{ $usr->whatsapp }}</td>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/users/' . $usr->id . '/edit') }}"
                                            class="btn btn-icon btn-info" data-bs-toggle="tooltip" title="Edit User">
                                            <span class="svg-icon svg-icon-2">
                                        ...
                                        <button class="btn btn-icon btn-xs btn-delete-user btn-danger"
                                            data-url="{{ url('admin/users/' . $usr->id) }}" data-bs-toggle="tooltip"
                                            title="Hapus User">
                                            <span class="svg-icon svg-icon-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
