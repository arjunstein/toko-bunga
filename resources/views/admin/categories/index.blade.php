                    ...
                    <tbody class="fw-bold text-gray-600">
                        @foreach ($category as $e => $ctg)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/categories/' . $ctg->id . '/edit') }}"
                                        class="btn btn-icon btn-info" data-bs-toggle="tooltip" title="Edit Kategori">
                                    ...
                                    <button class="btn btn-icon btn-delete btn-danger"
                                        data-url="{{ url('admin/categories/' . $ctg->id) }}" data-bs-toggle="tooltip"
